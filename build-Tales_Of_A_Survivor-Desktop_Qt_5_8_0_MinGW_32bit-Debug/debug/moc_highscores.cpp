...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_HighScores_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_HighScores_t qt_meta_stringdata_HighScores = {
    {
QT_MOC_LITERAL(0, 0, 10) // "HighScores"
...
const QMetaObject HighScores::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_HighScores.data,
      qt_meta_data_HighScores,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *HighScores::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_HighScores.stringdata0))
